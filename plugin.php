...
class pluginSEARCH extends Plugin {
	...
	private function createXML()
	{
		...
		$posts = buildPostsForPage(0, 500, true);
    ...
    $xml .= '<media:thumbnail xmlns:media="http://search.yahoo.com/mrss/" url="'.DOMAIN_BASE.''.$Post->coverImage().'" height="72" width="72"/>';
			$xml .= '</item>';
		}
...
$ccc = ($_SERVER[ 'DOCUMENT_ROOT' ]);
		$doc->save($ccc.'/rss.xml');
		$doc->save($ccc.'/bl-plugins/search/search.xml');
